...
function renderAnalysis(d) {
  ...
  return `
    <div style="margin-top:20px;padding:16px 20px;background:#fff;border:1px solid #edf2f7;border-radius:10px">
      ...
      ${a.advice ? `<div style="font-size:13px;color:#1a1a2e;line-height:1.8;padding:10px 14px;background:#f0f4ff;border-radius:6px;border-left:3px solid #4a6cf7"><strong>选股建议：</strong>${a.advice}</div>` : ''}
