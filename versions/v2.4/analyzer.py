...
COMPANY_PROFILES = {
    ...
    '9880.HK':      {'industry': '机器人', 'desc': '中国最知名的通用人形机器人上市企业（优必选），',
...
def get_peers(code: str) -> list[dict]:
    ...
    # market reference fallback: suggest well-known stocks from same market
    market = _detect_market_for_code(code)
    refs = {
        'a': [('600519.SH', '贵州茅台'), ('000858.SZ', '五粮液'), ('600036.SH', '招商银行')],
        'hk': [('00700.HK', '腾讯控股'), ('00388.HK', '港交所'), ('01299.HK', '友邦保险')],
        'us': [('AAPL', '苹果'), ('NVDA', '英伟达'), ('JPM', '摩根大通')],
    }
