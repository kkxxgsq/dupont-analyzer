...
<div class="header">
  <h1>杜邦分析 <span style="font-size:11px;color:#8899b0;font-weight:400">v7.5</span></h1>
...
function _cardFooter() {
  return `<div style="padding:16px 32px;text-align:center;font-size:11px;color:#9ca3af;border-top:1px solid #edf2f7">由 杜邦分析 v7.5 生成</div>`;
}
