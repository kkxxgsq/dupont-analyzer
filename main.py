...
// ── 股票性质定位 ─────────────────────────────────────────
const HEDGE_MAP = {
  '银行':     { hedge:'国债期货(T-bond Futures) / 做空银行ETF', reason:'利率周期敏感，国债对冲利率上行风险；银行ETF空头对冲系统性信用风险' },
  '保险':     { hedge:'国债期货(T-bond Futures) / 做空保险ETF', reason:'利率与资本市场周期敏感，国债对冲利率下行（压估值），保险ETF空头对冲权益市场风险' },
  '券商':     { hedge:'做空沪深300/恒生指数期货', reason:'强资本市场贝塔，指数期货对冲系统性牛市后回撤风险' },
  '煤炭':     { hedge:'焦炭/动力煤期货', reason:'强能源价格周期，对应商品期货直接对冲价格风险' },
  '石油':     { hedge:'原油期货(WTI/Brent)', reason:'强国际油价周期，原油期货直接对冲价格风险' },
  '新能源':   { hedge:'做空光伏/锂电池行业ETF + 国债期货', reason:'产能周期敏感，行业ETF空头对冲产能过剩风险；国债对冲流动性收紧' },
  '新能源车': { hedge:'做空新能源车ETF + 铜期货空头', reason:'价格战+需求周期敏感，行业ETF空头对冲竞争恶化；铜期货对冲原材料成本' },
  '半导体':   { hedge:'纳指(NDX)期货 / 费城半导体指数期货', reason:'科技资本开支周期+全球贸易敏感，纳指/费城半导体期货对冲科技贝塔' },
  '消费电子': { hedge:'做空消费电子ETF + 离岸人民币(CNH)期货', reason:'产品周期+汇率敏感，消费电子ETF空头对冲换机周期下行；CNH期货对冲汇率风险' },
  '白酒':     { hedge:'做空消费ETF + 国债期货', reason:'弱周期但高估值，消费ETF空头对冲消费下行，国债对冲流动性收缩杀估值' },
  '食品':     { hedge:'做多国债期货（防御配置）', reason:'必需消费品弱周期，国债提供稳定性对冲；无需做空，食品为天然防御仓位' },
  '家电':     { hedge:'做空地产ETF + 做多国债期货', reason:'地产后周期，地产ETF空头对冲竣工下行；国债对冲系统性风险' },
  '医药':     { hedge:'做多国债期货（防御配置）', reason:'医药弱周期，国债提供防御性配置；创新药标的可加做空生物科技ETF对冲管线失败风险' },
  '医疗器械': { hedge:'做多国债期货 + 做空医疗政策ETF', reason:'医院采购+集采政策敏感，国债对冲系统性风险；医疗政策ETF空头对冲带量采购冲击' },
  '电商零售': { hedge:'做多国债期货 + 做空消费ETF', reason:'弱周期但消费敏感，国债防御；消费ETF空头对冲消费下行' },
  '商超零售': { hedge:'做多国债期货（防御配置）', reason:'弱消费周期，工资上涨压力可通过运营效率消化；国债提供防御' },
  '互联网平台':{ hedge:'做多国债期货 + 做空中概互联ETF', reason:'广告+消费周期敏感+监管风险，国债对冲系统性风险；中概ETF空头对冲地缘/监管风险' },
  '企业软件': { hedge:'做多纳指(NDX)期货（科技成长配置）', reason:'弱周期+AI驱动，纳指期货作为科技成长贝塔敞口；无需做空' },
  '本地生活': { hedge:'做多国债期货 + 做空消费ETF', reason:'消费场景敏感，国债防御；消费ETF空头对冲经济下行' },
  '自动化':   { hedge:'做空工业周期ETF + 做多国债期货', reason:'制造业PMI周期敏感，工业ETF空头对冲资本开支下行；国债对冲衰退' },
  '机器人':   { hedge:'做多纳指(NDX)期货（新兴成长配置）', reason:'AI产业发展驱动，纳指期货作为科技贝塔敞口；尚未产生稳定利润，避免单边做空' },
  '建筑':     { hedge:'做空基建ETF + 做多国债期货', reason:'基建投资周期敏感，基建ETF空头对冲财政收缩；国债对冲地产下行传递' },
  '建材':     { hedge:'做空水泥/建材ETF + 做多国债期货', reason:'强地产基建周期，建材ETF空头对冲开工下行；国债防御' },
  '船舶制造': { hedge:'做空航运/造船ETF + 做多国债期货', reason:'航运景气周期敏感，造船ETF空头对冲新船订单下滑；国债对冲衰退' },
  '电信':     { hedge:'做多国债期货（类债券配置）', reason:'弱周期+高股息+现金流稳定，国债提供类债券配置增强；无需做空' },
  '食品':     { hedge:'做多国债期货（防御配置）', reason:'必需消费品弱周期，国债防御配置' },
  '自动化':   { hedge:'做空工业ETF + 做多国债期货', reason:'制造业PMI周期敏感，工业ETF空头对冲资本开支下行' },
  '黄金':     { hedge:'做多VIX期货 / 做空美元指数', reason:'黄金本身是避险资产，对冲尾部风险使用波动率产品' },
  'default':  { hedge:'做多国债期货（通用防御）', reason:'通用防御配置，国债期货对冲系统性下行风险' },
};
